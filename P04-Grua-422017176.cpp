...
int main()
{
	...
	*/
	...
	glm::mat4 modelBase(1.0);//Segunda matriz auxiliar para la base
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//BASE
		model = modelBase;
		model = glm::translate(model, glm::vec3(0.0f, -2.0f, 0.0f));//La piramide esta un poco "metida"
		modelBase = model;
		...
		//Llanta 1
		model = modelBase;
		model = glm::translate(model, glm::vec3(-3.0f, -1.5f, 1.5f));//La piramide esta un poco "metida"
		...
		//Llanta 2
		model = modelBase;
		model = glm::translate(model, glm::vec3(0.0f, -3.0f, 0.0f));//La piramide esta un poco "metida"
		modelBase = model;
		...
		//Llanta 3
		model = modelBase;
		model = glm::translate(model, glm::vec3(6.0f, 0.0f, 0.0f));//La piramide esta un poco "metida"
		modelBase = model;
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(2.5f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(-135.0f), glm::vec3(0.0f, 0.0f, 1.0f));//regresa ejes normal
		...
		//
		//La cabina y el brazo deben de estar unidos a la cabina (la cabina se hace al inicio del codigo)
