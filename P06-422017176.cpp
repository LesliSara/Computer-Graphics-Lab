...
void CrearDado()
{
	...
	GLfloat cubo_vertices[] = {
		...
		//top back
		-0.5f,		0.0f,		-0.5f,		0.59f,   0.51f,		0.0f,	0.0f,	1.0f,	//3
		0.5f,		0.0f,		-0.5f,		0.41f,	0.51f,		0.0f,	0.0f,	1.0f,	//4
		0.0f,		0.65f,		0.0f,		0.50f,	0.99f,		0.0f,	0.0f,	1.0f,	//5
		//top right
		0.5f,		0.0f,		0.5f,		0.21f,   0.51f,		-1.0f,	0.0f,	0.0f,	//6
		0.5f,		0.0f,		-0.5f,		0.39f,	0.51f,		-1.0f,	0.0f,	0.0f,	//7
		0.0f,		0.65f,		0.0f,		0.30f,	0.99f,		-1.0f,	0.0f,	0.0f,	//8
		//top left
		-0.5f,		0.0f,		0.5f,		0.79f,   0.51f,		1.0f,	0.0f,	0.0f,	//9
		-0.5f,		0.0f,		-0.5f,		0.61f,	0.51f,		1.0f,	0.0f,	0.0f,	//10
		0.0f,		0.65f,		0.0f,		0.70f,	0.99f,		1.0f,	0.0f,	0.0f,	//11


		//bottom front
		-0.5f,		0.0f,		0.5f,		0.50f,   0.01f,		0.0f,	0.0f,	-1.0f,	//12
		0.5f,		0.0f,		0.5f,		0.41f,	0.49f,		0.0f,	0.0f,	-1.0f,	//13
		0.0f,		-0.65f,		0.0f,		0.59f,	0.49f,		0.0f,	0.0f,	-1.0f,	//14
		//bottom back		
		-0.5f,		0.0f,		-0.5f,		0.01f,   0.49f,		0.0f,	0.0f,	1.0f,	//15
		0.5f,		0.0f,		-0.5f,		0.10f,	0.01f,		0.0f,	0.0f,	1.0f,	//16
		0.0f,		-0.65f,		0.0f,		0.19f,	0.49f,		0.0f,	0.0f,	1.0f,	//17
		//bottom right		
		0.5f,		0.0f,		0.5f,		0.99f,   0.51f,		-1.0f,	0.0f,	0.0f,	//18
		0.5f,		0.0f,		-0.5f,		0.81f,	0.51f,		-1.0f,	0.0f,	0.0f,	//19
		0.0f,		-0.65f,		0.0f,		0.90f,	0.99f,		-1.0f,	0.0f,	0.0f,	//20
		//bottom left		
		-0.5f,		0.0f,		0.5f,		0.21f,   0.49f,		1.0f,	0.0f,	0.0f,	//21
		-0.5f,		0.0f,		-0.5f,		0.30f,	0.01f,		1.0f,	0.0f,	0.0f,	//22
		0.0f,		-0.65f,		0.0f,		0.39f,	0.49f,		1.0f,	0.0f,	0.0f,	//23
...
int main()
{
	...
	Dado_Animales_M = Model();
	Dado_Animales_M.LoadModel("Models/Dado_Animales.obj");
